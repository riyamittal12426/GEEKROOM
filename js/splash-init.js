...
(function() {
    ...
    function isMobileDevice() {
        ...
        const isMobileUserAgent = mobileRegex.test(userAgent) || mobileRegex2.test(userAgent.substr(0, 4));
    ...
    function initSplashCursor() {
        ...
        // Check if device is mobile and skip initialization
        if (isMobileDevice()) {
            console.log('Mobile device detected - Splash cursor disabled for better scrolling experience');
            window.splashActive = false;
            return false;
        }
